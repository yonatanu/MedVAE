...
class AutoencoderKL(torch.nn.Module):
    def __init__(self, ddconfig, embed_dim, ckpt_path=None, ignore_keys=[], apply_channel_ds=True, state_dict=True):
        super().__init__()
        ...
        if ckpt_path is not None:
            self.init_from_ckpt(ckpt_path, ignore_keys=ignore_keys, state_dict=state_dict)
